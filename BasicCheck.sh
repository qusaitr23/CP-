...
_Comp=$?
 ...
 if [ $_Comp -gt 0 ]; then
  ...
  _S=$((4*$_Compilation+2*$_Valgrind_RES+1*$_Helgrind_RES))
  	...
  	echo "BasicCheck.sh <$_Path> <$_Program> Compilation   Memory leaks   Thread Race  $_Ans0   ,   $_Ans1  , $_Ans2"         
